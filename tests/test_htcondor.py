...
TEST_JOBS = [
    ...
    {"Owner": "test_user0", "ProcId": 1, "ClusterId": 12345, "JobStatus": 5, "RequestGPUs": 0},
    {"Owner": "test_user0", "ProcId": 1, "ClusterId": 12345, "JobStatus": 5, "RequestGPUs": 1},
    {
        "Owner": "test_user1",
        "ProcId": 0,
        "ClusterId": 12346,
...
EXPECTED_RESULT = {
    ...
    "test_user1": {"CPU": {}, "GPU": {"Idle": 1, "Running": 1}, "Total": {"Idle": 1, "Running": 1}},
}
